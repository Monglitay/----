...
//     return 0;
// }
// #define GYRO_LSB_SCALE (2000.0f / 32768.0f) 
// /**
//  * @brief 更新MPU6050数据
//  */
...
//     //ax = acc_raw[0] * (2.0f / 32768.0f);
//     //ay = acc_raw[1] * (2.0f / 32768.0f);
//     //az = acc_raw[2] * (2.0f / 32768.0f);
    
//     //gx = gyro_raw[0] * GYRO_LSB_SCALE;
//     //gy = gyro_raw[1] * GYRO_LSB_SCALE;
//     gz = gyro_raw[2] * GYRO_LSB_SCALE;
